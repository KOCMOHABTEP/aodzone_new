...
export const VideoPlayerControlPanel = (
  ...
  const handleShowTooltip = (event: MouseEvent<HTMLInputElement>) => {
    ...
    const tooltipPosition = Number(
      ((tooltipPositionInfoWidth * 100) / timelinePositionInfoWidth).toFixed(2)
    );
        ...
        <div className={styles.inner}>
          <div className={styles.item}>
            ...
            {!isPlaying && (
              <div onClick={handlePlay}>
                <Icon className={styles.item__icon} name="play" size={24} />
              </div>
            )}
          </div>
          <div className={styles.timeline}>
            <div
              ...
              className={cn(styles.tooltip, {
                [styles.tooltip__visible]: tooltipData.visibility,
              })}
          ...
          <div className={styles.item}>
            <div onClick={handleFullscreenMode}>
              <Icon className={styles.item__icon} name="fullscreen" size={24} />
            </div>
          </div>
        </div>
      </div>
