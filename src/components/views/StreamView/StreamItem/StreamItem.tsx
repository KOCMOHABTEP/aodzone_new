        ...
        <div className={styles.header}>
          ...
          {online && (
            <div className={cn(styles.info, styles.info__live)}>
              <Icon className={styles.info__icon} name="streams" size={16} />
              <div className={styles.info__label}>LIVE</div>
            </div>
          )}

          <div className={cn(styles.info, styles.info__stats)}>
            <Icon className={styles.info__icon} name="views" size={16} />
        ...
        <div className={styles.content}>
          ...
          <div className={styles.text}>
            ...
            <div className={styles.wrapper}>
              ...
              <span className={cn(styles.description, styles.separation)}>
                •
              </span>
