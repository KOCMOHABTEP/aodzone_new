        ...
        <div className={styles.content}>
          <div className={styles.header}>
            ...
            <div className={styles.right}>
              ...
              <div className={styles.right__additional}>. . .</div>
            </div>
          </div>
            ...
            <div className={styles.wrapper}>
              <div className={styles.wrapper__header}>
                <div className={styles.wrapper__info}>
                  <Icon name="friends" />
                  <div className={styles.itemInfoHeaderTitleText}>
                    Call of Duty Ghost
                  </div>
                </div>
                <div>
                  <Button
                    buttonClassName={styles.itemInfoHeaderButton}
                    text="Поделиться"
                  />
                </div>
              </div>
              ...
              <div className={styles.infoJoinMatchesBanner}>
                ...
                <div className={styles.itemJoinInfo}>Starting in 5D 3H 12M</div>
              </div>
            </div>
          </div>
        </div>
