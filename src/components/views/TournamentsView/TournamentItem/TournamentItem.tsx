    ...
    if (type === 'FINISHED') {
      return (
        <div className={styles.winner}>
          <Icon className={styles.winner__icon} name="views" size={16} />
        ...
        <div className={styles.container}>
          <div className={styles.top}>
            <div className={styles.top__image}>
              <img className={styles.top__img} src={src} alt="фон" />
            </div>
          ...
          <div className={styles.bottom}>
            <div className={styles.content}>
              <div className={styles.content__row}>
                ...
                <Icon className={styles.content__icon} name="like" size={16} />
              </div>
            ...
            <div className={styles.info}>
              <div className={styles.column}>
                <div className={styles.card}>
                  <div className={styles.card__title}>FORMAT</div>
                  <div className={styles.card__value}>5 vs 5</div>
                </div>
                <div className={styles.card}>
                  <div className={styles.card__title}>ENTRY</div>
                  <div className={styles.card__value}>FREE</div>
                </div>
                <div className={styles.card}>
                  <div className={styles.card__title}>PRICE</div>
                  <div className={styles.card__value}>20$</div>
                </div>
              </div>
              <div className={styles.column}>{renderTournamentActions()}</div>
            </div>
          </div>
        </div>
      </>
