    ...
    <div className={styles.item}>
      ...
      <div>
        ...
        <div className={styles.wrapper}>
          <div className={styles.wrapperTitle}>Основная информация</div>
          <div className={styles.block}>
            <div className={styles.input}>
              <Input label="Название" {...teamForm.register('teamName')} />
            </div>
            <div className={styles.input}>
            ...
            <div className={styles.input}>
              <Dropdown
                ...
                onSelect={({ option }) => setDropdownLocal(option.value)}
              />
            </div>
          </div>
        </div>
        <div className={styles.wrapper}>
          ...
          <div className={styles.block}>
            <div className={styles.input}>
              <Input label="Сайт" {...teamForm.register('teamLinkWebsite')} />
            </div>
            <div className={styles.input}>
              <Input
        ...
        <div>
          <div className={styles.wrapperTitle}>Приглашение в команду</div>
          <div className={styles.block}>
            <div className={styles.input}>
              <Input
