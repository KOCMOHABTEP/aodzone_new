...
export const LoginView = () => {
  ...
  const handleRegister: SubmitHandler<RegistrationFormValues> = async (
    data
  ) => {
  ...
  const renderProcessForm = () => {
      ...
      return (
        <div className={styles.content}>
          <div className={styles.contentHead}>
            ...
            <div className={styles.contentHeadDescription}>Войти в аккаунт</div>
          </div>
            ...
            <div className={styles.contentRow}>
              <div className={styles.contentInfo}>
                <a
                  ...
                  onClick={() => setLoginProcess('forget_password')}
                >
                  Забыли пароль?
                </a>
              </div>
            ...
            <div className={styles.contentRow}>
              <div className={styles.contentFooter}>
                ...
                <a
                  ...
                  onClick={() => setLoginProcess('registration')}
                >
                  Регистрация
                </a>
              </div>
    ...
    if (loginProcess === 'registration') {
      return (
        <div className={styles.content}>
          <div className={styles.contentHead}>
            <div className={styles.contentHeadTitle}>Регистрация</div>
            <div className={styles.contentHeadDescription}>Создать аккаунт</div>
          </div>
          ...
          <div className={styles.contentBody}>
            ...
            <div className={styles.contentRow}>
              <Input
                ...
                type="password"
                {...registrationForm.register('passwordConfirmation', {
                  required: 'Поле должно быть заполнено',
                })}
                error={
                  registrationForm.formState.errors.passwordConfirmation
                    ?.message
                }
              />
            </div>
            ...
            <div className={styles.contentRow}>
              <Button
                ...
                onClick={registrationForm.handleSubmit(handleRegister)}
    ...
    if (loginProcess === 'forget_password') {
      return (
        <div className={styles.content}>
          <div className={styles.contentHead}>
            <div className={styles.contentHeadTitle}>Забыли пароль?</div>
            <div className={styles.contentHeadDescription}>
              Не волнуйтесь, мы пришлем все инструкции для восстановления пароля
            </div>
          </div>
