...
export const PlayersView = () => {
  const playersViewList = [
    {
      ...
      tag: 'AOD',
      image:
        'https://www.meme-arsenal.com/memes/9018adbc4dc80835becaa3baebd84ed9.jpg',
      title: 'Лупчики',
      country: 'BY',
      games: 1456,
      wins: 56,
    ...
    },
    {
      ...
      tag: 'CAN',
      image:
        'https://i.pinimg.com/474x/a2/6b/36/a26b36c58ec2c4fb531a82c2996d5a05.jpg',
      title: 'Counter',
      country: 'AE',
      games: 1456,
      wins: 56,
    },
    {
      ...
      tag: 'CAN',
      image:
        'https://abrakadabra.fun/uploads/posts/2021-12/thumbs/1640356667_42-abrakadabra-fun-p-avi-dlya-timi-v-standoff-46.jpg',
      title: 'Counter',
      country: 'AM',
      games: 13,
      wins: 6,
    },
    {
      ...
      tag: 'CAN',
      image:
        'https://abrakadabra.fun/uploads/posts/2021-12/thumbs/1640713678_27-abrakadabra-fun-p-sinie-avatarki-dlya-standoff-29.jpg',
      title: 'Counter',
      country: 'KZ',
      games: 1456,
      wins: 56,
  ...
  return (
    <div>
      ...
      <Table>
        <TableHead labels={['', 'Баллы', 'Игрок', 'Игр', 'Побед', '% побед']} />

        <TableBody>
          {playersViewList.map(
            (
              { number, points, tag, image, title, country, wins, games },
              index
            ) => (
              <TableRow key={index}>
                <TableCell>
                ...
                <TableCell>
                  <WinsPercentage
                    value={`${parseFloat((games / wins).toFixed(2))}%`}
                  />
                </TableCell>
              </TableRow>
            )
