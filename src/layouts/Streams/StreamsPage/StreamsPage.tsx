...
const StreamsPage = () => {
    return (
        <div className={styles.item}>
            <div className={styles.itemTitle}>СТРИМЫ</div>
            <div className={styles.itemHeader}>
                <div className={styles.itemHeaderTitle}>ПОПУЛЯРНЫЕ ИГРЫ</div>
                <StreamFilterIAll />
            </div>
            <div className={styles.itemGamesList}>
                <StreamsGames
                    nameGame="Fortnite"
                    views={258}
            ...
            <div>
                <StreamsFilter />
                <div className={styles.itemStreamList}>
                    <StreamItem
